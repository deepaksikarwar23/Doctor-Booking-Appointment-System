...
const Appointment = () => {
  ...
  // function to make axios call to book the appointment
  ...
  // function to get the available slots 
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // 🎯 THE PRO FIX: Added the '?' operator right after docInfo
  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4 '>
        ...
        {/*---------- Doctor details- name, degree, specialist , experience ---------------*/}
