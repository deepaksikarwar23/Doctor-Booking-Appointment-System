          ...
          appointments.map((item, index) => (
            ...
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b border-gray-300' key={index}>
              ...
              <div className='flex-1 text-sm text-zinc-600 '>
                ...
                <p className='text-xs'>{typeof item.docData.address === 'string' ? JSON.parse(item.docData.address).line1 : item.docData.address?.line1}</p>
                <p className='text-xs'>{typeof item.docData.address === 'string' ? JSON.parse(item.docData.address).line2 : item.docData.address?.line2}</p>
